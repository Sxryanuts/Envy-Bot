...
/*============= WAKTU =============*/
let wibh = moment.tz('Asia/Ujung_Pandang').format('HH')
    let wibm = moment.tz('Asia/Ujung_Pandang').format('mm')
    let wibs = moment.tz('Asia/Ujung_Pandang').format('ss')
...
global.gcname = 'Eternal'//nama group kalian
global.author = 'amora'
global.namebot = 'ᴇɴᴠʏʙᴏᴛ'
global.wm = 'ᴇɴᴠʏʙᴏᴛ'
global.media = 'https://telegra.ph/file/b9c38c34238271d29e86e.jpg'
global.watermark = wm
global.status = 'public'
global.danied = '          ⚠️ 𝐀𝐜𝐜𝐞𝐬 𝐃𝐚𝐧𝐢𝐞𝐝 ⚠️  '
global.wame = 'https://wa.me/6283877362998'
global.alllink = `https://youtube.com`
global.wm2 = ' ᴇɴᴠʏʙᴏᴛ '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ TIME: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `ᴇɴᴠʏʙᴏᴛ`
global.stickpack = 'Created by: '
global.stickauth = `©ᴇɴᴠʏʙᴏᴛ`
global.week = `${week} ${date}`
global.wibb = `${wktuwib}`
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ OWNER INFO ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.nameown1= '#Envy'
global.nameown2 = 'ᴇɴᴠʏʙᴏᴛ'
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ MEDIA LINK ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.Linkgc = '-'
global.lynk = '-'
...
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ TAMPILAN ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.ListHargaSewa = 'engga ada'
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ TAMPILAN ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.LyAtas1 = '☰ ━━━ ❨'
global.LyAtas2 = '❩ ━━┄┈ •⟅'
global.Ly = '┃'
...
global.urlnya = "cari sendiri"
global.dtc = 'ᴄᴀʟʟ ᴏᴡɴᴇʀ'
global.phn = 'cari sendiri'
...
function ucapan() {
  const time = moment.tz('Asia/Ujung_Pandang').format('HH')
